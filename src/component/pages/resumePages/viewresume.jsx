...
export function ViewResume() {
  ...
  useEffect(()=>{
    axios({
      method:'get',
      url:`http://127.0.0.1:5080/getuserresume`
    }).then(response=>{
...
<div className="container">
    <div className="resume-header text-center">
        ...
        <h1>{resume[0].UserName}</h1>
        <p>Hyderabad, Currently in Bangalore |  in [Specialization] | 4.6 years of experience in UI with Angular</p>
    </div>
